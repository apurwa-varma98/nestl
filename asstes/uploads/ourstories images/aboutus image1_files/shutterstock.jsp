	...
	usi_commons = {
		...
		load_products:function(options) {
			try {
				...
				usi_commons.load_script(usi_commons.cdn + '/utility/'+(options.siteID % 10 < 6 ? "product_recommendations_filter_v2" : "product_recommendations_filter")+'.jsp' + queryStr, function(){
